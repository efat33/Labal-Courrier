...
$shipment_created_response = unserialize($shipment->shipment_created_response);

$selected_carrier = str_replace("CARRIER_", "", $shipment->selected_carrier_id);
$earliest_pickup_time = isset($shipment->earliest_pickup_time) ? $shipment->earliest_pickup_time : '';
$latest_pickup_time = isset($shipment->latest_pickup_time) ? $shipment->latest_pickup_time : '';
$waybill_number = isset($shipment->tracking_number) ? $shipment->tracking_number : '';
$pickup_number = isset($shipment_created_response['dispatch_confirmation_nummber']) ? $shipment_created_response['dispatch_confirmation_nummber'] : '';
...
<head>
  ...
  <style type="text/css">
    #ko_doubleArticleBlock_2 .links-color a,
    #ko_doubleArticleBlock_2 .links-color a:link,
    #ko_doubleArticleBlock_2 .links-color a:visited,
    #ko_doubleArticleBlock_2 .links-color a:hover {
      color: #3f3f3f;
      color: #112A46;
...
<body bgcolor="#3f3f3f" text="#919191" alink="#cccccc" vlink="#cccccc" style="margin: 0; padding: 0; background-color: #3f3f3f; color: #919191;">
  ...
  <center>
    ...
    <table role="presentation" class="vb-outer" width="100%" cellpadding="0" border="0" cellspacing="0" bgcolor="#faf5ea" style="background-color: #faf5ea;" id="ko_textBlock_3">
      <tbody>
        <tr>
          <td class="vb-outer" align="center" valign="top" style="padding-left: 9px; padding-right: 9px; font-size: 0;">
            <!--[if (gte mso 9)|(lte ie 8)]><table role="presentation" align="center" border="0" cellspacing="0" cellpadding="0" width="570"><tr><td align="center" valign="top"><![endif]-->
                ...
                <tbody>
                  <tr>
                    <td class="long-text links-color" width="100%" valign="top" align="left" style="font-weight: normal; color: #112A46; font-size: 13px; font-family: Arial, Helvetica, sans-serif; text-align: left; line-height: normal;">
                      ...
                      <p style="margin: 1em 0px;">Je vous prie de trouver vos documents d'expédition à imprimer dans
                        leur intégralité ainsi que votre facture.</p>
                      <p style="margin: 1em 0px;">L'enlèvement de votre envoi est programmé pour le <strong><?= $pickup_date ?></strong>&nbsp;entre <strong><?= $earliest_pickup_time ?></strong> et <strong><?= $latest_pickup_time ?></strong>.</p>
                      <p style="margin: 1em 0px;">Voici les références de votre envoi&nbsp;:</p>
                      <p style="margin: 1em 0px;">Numéro de suivi <strong><?= $selected_carrier ?></strong> : <strong><?= $waybill_number ?></strong><br>Votre numéro d'enlèvement&nbsp;: <strong><?= $pickup_number ?></strong></p>
                      <p style="margin: 1em 0px;">Vous pouvez suivre l'expédition de votre envoi sur <a href="http://www.moncourrierdefrance.com" style="color: #3f3f3f; color: #112A46; text-decoration: underline;">moncourrierdefrance.com</a><br><br>
                      </p>
                      <p style="margin: 1em 0px; margin-bottom: 0px;">Nous vous remercions pour votre confiance.</p>
                    </td>
                  </tr>
    ...
    <table role="presentation" class="vb-outer" width="100%" cellpadding="0" border="0" cellspacing="0" bgcolor="#faf5ea" style="background-color: #faf5ea;" id="ko_doubleArticleBlock_2">
      <tbody>
        <tr>
          <td class="vb-outer" align="center" valign="top" style="padding-left: 9px; padding-right: 9px; font-size: 0;">
            <!--[if (gte mso 9)|(lte ie 8)]><table role="presentation" align="center" border="0" cellspacing="0" cellpadding="0" width="570"><tr><td align="center" valign="top"><![endif]-->
        ...
        -->
                          <table role="presentation" class="vb-content" border="0" cellspacing="9" cellpadding="0" style="border-collapse: separate; width: 100%; mso-cellspacing: 9px; border-spacing: 9px; -yandex-p: calc(2px - 3%);" width="276" align="left">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td class="long-text links-color" width="100%" valign="top" align="left" style="font-weight: normal; color: #112A46; font-size: 13px; font-family: Arial, Helvetica, sans-serif; text-align: left; line-height: normal;">
                                  <p style="margin: 1em 0px; margin-bottom: 0px; margin-top: 0px;">Envoi <strong><?= $selected_carrier ?> <?= $waybill_number ?></strong></p>
                                </td>
                              </tr>
                              <tr>
                                      ...
                                      <tr>
                                        <td width="auto" valign="middle" align="left">
                                          <span style="text-align: center; font-weight: normal; padding: 6px; padding-left: 18px; padding-right: 18px; background-color: #64CB64; color: #112A46; font-size: 16px; font-family: Arial, Helvetica, sans-serif; border-radius: 20px; margin: 10px 0 0; display:block;">
                                            ...
                                            ?>
                                              <a style="text-decoration: none; font-weight: normal; color: #112A46; font-size: 16px; font-family: Arial, Helvetica, sans-serif;" target="_new" href="<?= LABAL_COURRIER_PLUGIN_URL . '/docs/' . $only_carrier_dir . '/' . $waybill_number . '/Documents-expedition-' . $waybill_number . '.pdf' ?>">Documents expedition</a>
                                            <?php } else { ?>
                                              <a style="text-decoration: none; font-weight: normal; color: #112A46; font-size: 16px; font-family: Arial, Helvetica, sans-serif;" target="_new" href="<?= LABAL_COURRIER_PLUGIN_URL . '/docs/' . $only_carrier_dir . '/' . $waybill_number . '/Documents-expedition-' . $waybill_number . '.pdf' ?>">Documents expedition</a>
                                            <?php } ?>
                                          </span>
        ...
        -->
                          <table role="presentation" class="vb-content" border="0" cellspacing="9" cellpadding="0" style="border-collapse: separate; width: 100%; mso-cellspacing: 9px; border-spacing: 9px; -yandex-p: calc(2px - 3%);" width="276" align="left">
                            ...
                            <tbody>
                              <tr>
                                <td width="100%" valign="top" align="center" class="links-color" style="padding-bottom: 9px;">
                                  <!--[if (lte ie 8)]><div style="display: inline-block; width: 258px; -mru-width: 0px;"><![endif]--><img border="0" hspace="0" align="center" vspace="0" width="258" style="border: 0px; display: block; vertical-align: top; height: auto; margin: 0 auto; color: #112A46; font-size: 13px; font-family: Arial, Helvetica, sans-serif; width: 100%; max-width: 258px; height: auto;" src="https://mosaico.io/srv/f-zjpstq9/img?src=https%3A%2F%2Fmosaico.io%2Ffiles%2Fzjpstq9%2F2.png&amp;method=resize&amp;params=258%2Cnull">
                                  <!--[if (lte ie 8)]></div><![endif]-->
                                </td>
                              </tr>
                              <tr>
                                <td width="100%" valign="top" align="left" style="font-weight: normal; color: #112A46; font-size: 18px; font-family: Arial, Helvetica, sans-serif; text-align: left;">
                                  <span style="font-weight: normal;">Ma facture&nbsp;</span>
                                </td>
                              </tr>
                              <tr>
                                <td class="long-text links-color" width="100%" valign="top" align="left" style="font-weight: normal; color: #112A46; font-size: 13px; font-family: Arial, Helvetica, sans-serif; text-align: left; line-height: normal;">
