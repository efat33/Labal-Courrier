...
use Dhl\Express\Model\Request\Shipment\ExportLineItem;
...
use Dhl\Express\Model\Request\Shipment\ExportDeclaration;
...
class ShipmentRequestBuilder implements ShipmentRequestBuilderInterface
{
    ...
    public function setRequestPickupDetails($requestPickupDetails)
    {
        $this->data['isPickupDetailsRequested'] = $requestPickupDetails;
        return $this;
    }
    ...
    public function setDHLCustomsInvoiceRequested(bool $isRequested): ShipmentRequestBuilderInterface
    {
        $this->data['labelOptions']['customsInvoiceRequested'] = $isRequested;
        return $this;
    }

    public function setDHLCustomsInvoiceType(string $customsInvoiceType): ShipmentRequestBuilderInterface
    {
        $this->data['labelOptions']['customsInvoiceType'] = $customsInvoiceType;
        return $this;
    }
    ...
    public function setExportDecalaration(
        $invoiceDate,
        $invoiceNumber,
        $exportReasonType,
        $exportReason
    ): ShipmentRequestBuilderInterface {
        $this->data['exportDeclaration'] = [
    ...
    public function addExportLineItem(
        ...
        float $netWeight,
        float $grossWeight,
        string $manufacturingCountryCode,
        string $exportReasonType
    ): ShipmentRequestBuilderInterface {
        $this->data['exportLineItems'][] = [
    ...
    public function build(): ShipmentRequestInterface
    {
        ...
        $shipmentDetails = new ShipmentDetails(
            ...
            $this->data['isPickupDetailsRequested']
        );
        ...
        foreach ($this->data['exportLineItems'] as $exportLineItem) {
            ...
            $exportLineItems[] = new ExportLineItem(
                ...
                $exportLineItem['exportReasonType']
            );
        }
        ...
        if (isset($this->data['exportDeclaration']) && \is_array($this->data['exportDeclaration'])) {
            $exportDeclaration = new ExportDeclaration(
                $this->data['exportDeclaration']['invoiceDate'],
                $this->data['exportDeclaration']['invoiceNumber'],
                $this->data['exportDeclaration']['exportReasonType'],
                $this->data['exportDeclaration']['exportReason']
            );
        ...
        if (!empty($this->data['labelOptions']) && isset($this->data['labelOptions']['waybillDocument'])) {
            $labelOptions = new LabelOptions(
                ...
                $this->data['labelOptions']['customsInvoiceRequested'],
                $this->data['labelOptions']['customsInvoiceType']
            );
