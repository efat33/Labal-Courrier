...
use Dhl\Express\Webservice\Soap\Type\ShipmentRequest\ShipmentInfo\RequestPickupDetails;
...
class ShipmentInfo
{
     ...
     */
    public function __construct($dropOffType, $serviceType, $currencyCode, $requestPickupDetails, $unitOfMeasurement )
    {
    ...
    /**
     * Returns the request pickup details.
     *
     * @return RequestPickupDetails
     */
    public function getRequestPickupDetails()
    {
        return $this->RequestPickupDetails;
    }

    /**
     * Sets the request pickup details.
     *
     * @param string $requestPickupDetails the request pickup details.
     *
     * @return self
     */
    public function setRequestPickupDetails($requestPickupDetails)
    {
        $this->RequestPickupDetails = new RequestPickupDetails($requestPickupDetails);
        return $this;
    }
