                ...
                foreach ($provider->getService() as $service) {
                    ...
                    foreach ($totals as $total) {
                        ...
                        if (!empty($chargeComponents)) {
                            ...
                            foreach ($chargeComponents as $chargeComponent) {
                                if ($chargeComponent->getChargeCode() == "II" || $chargeComponent->getChargeCode() == "IE") {
                                    $insurance = $chargeComponent->getChargeAmount();
                                } else {
                                    $insurance = (float) 0;
                                }
                            }
                        ...
                        $rate = new Rate($serviceCode, $label, $cost, $insurance, $currencyCode);
