                        ...
                        <div class="accordion rate-setting" id="zone_setting">
                            ...
                            foreach ($zoneObj->get_ups_expedited_export_zones() as $zone_id => $zone) :
                                ...
                                if (isset($user_coeffient_page) && $user_coeffient_page == 1) {
                                    $existingZoneValues = get_user_meta($_GET['user_id'], 'ups_expedited_export_rate_' . $zone_id, true);
                                } else {
                    ...
                    <div class="col-12">
                        <div class="accordion rate-setting" id="zone_i_setting">
                            ...
                            foreach ($zoneObj->get_ups_expedited_import_zones() as $zone_id => $zone) :
                                ...
                                if (isset($user_coeffient_page) && $user_coeffient_page == 1) {
                                    $existingZoneValues = get_user_meta($_GET['user_id'], 'ups_expedited_import_rate_' . $zone_id, true);
                                } else {
